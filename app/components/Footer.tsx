  ...
  return (
    <footer className="footer">
      <div>
        ...
        <p>
          Every scene answers one question. Inputs, assumptions and outputs stay visible.
          Synthetic data is labeled as such; third-party engines are credited, not claimed.
        </p>
      </div>
      <nav aria-label="Footer">
        <Link href="/stack">Technology stack</Link>
        <Link href="/methodology">Method and boundaries</Link>
        <Link href="/examples">Geospatial archive</Link>
